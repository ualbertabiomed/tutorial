# tutorial
This repository is used to have new members setup their personal computers with the makefile and arduino development environment to compile arduino at home. This repository is also used for members to complete the recruitment task. 
...
### Windows
**Pre - requisites:** basic knowledge of program installation on windows and navigating file explorer
...
**Cygwin terminal:** from now on, when working with the project, you need to use the Cygwin terminal and linux bash commands.
